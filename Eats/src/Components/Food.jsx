...
const Food = () => {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row justify-between">
        <div>
            ...
            <div className="flex justify-between flex-wrap ">
                <button onClick={()=> setgoods(info)} className="m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white">All</button>
   ...
   {goods.map((item,index)=>{
    return <div key={index} className="border shadow-2xl rounded-lg hover:scale-105 duration-300">
